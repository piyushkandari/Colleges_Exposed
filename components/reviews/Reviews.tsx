...
const Reviews= (props: {
  db: any; collection: any; rating:any;
}) => {
  let imgUrl = [];
...
{/* bg-gradient-to-r from-[#C2E9FB] to-[#E0D1F7]  */}
    <form onSubmit={session.data != null ?  handleSubmit : undefined } className=" mx-auto ">
            ...
            <div className="-xl container mt- px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-8 mx-auto text-gray-900 rounded-lg ">
                    <div className="flex flex-col justify-between">
                      ...
                      <div className="mt-8 mx-auto md:mx-0 ">
                        ...
                        <Image src={'/assets/images/svg1.png'} width={300} height={300} alt="" className="rounded-md " />
                      </div>
