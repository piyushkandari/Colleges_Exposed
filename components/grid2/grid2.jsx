...
const grid2 = (props) => {
  ...
  return (
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3  xl:container xl:mx-auto  '>
        <Card img= '/assets/images/academics.jpg' category={'Academics'}  page={'academics'} avg={ ((props.avgReviews[0].reviews[0].rating ) / (props.avgReviews[0].reviews[0].count)).toFixed(1)} count={(props.avgReviews[0].reviews[0].count)} />
            ...
            <Card img= '/assets/images/campuslife.jpg' category={'Campuslife'} page={'campuslife'} avg={ ((props.avgReviews[1].reviews[0].rating ) / (props.avgReviews[1].reviews[0].count)).toFixed(1)} count={(props.avgReviews[1].reviews[0].count)} />
            ...
            <Card img= '/assets/images/sports.jpg' category={'Sports life'} page={'sports'}  avg={ ((props.avgReviews[4].reviews[0].rating ) / (props.avgReviews[4].reviews[0].count)).toFixed(1)} count={(props.avgReviews[4].reviews[0].count)} />
    </div>
  )
}
