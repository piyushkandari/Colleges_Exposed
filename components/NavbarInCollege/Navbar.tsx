...
const Navbar = (props: Props) => {
  ...
  return (
    ...
    <li>
        <a href={`${props.sectionName}/${x._id}`} className="text-sm hover:bg-gray-100 text-black block px-4 py-2 ">{x.title}</a>
    </li>
))}
            ...
            <li>
            <a href="/about" className="text-black hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-400 md:p-0 md:text-white">AboutUs</a>
            </li>
            <li>
            <a href="/contact" className="text-black hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-400 md:p-0 md:text-white">ContactUs</a>
            </li>
            <li>
            <a href="/login" className="text-black hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-400 md:p-0 md:text-white flex justify-between"><FaUserAlt className="mr-2 mt-0.5"/>{props.userName}</a>
            </li>
        </ul>
        </div>
    </div>
